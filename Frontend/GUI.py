...
from PyQt5.QtGui import QFont, QPalette, QColor, QMovie, QTextCharFormat, QPixmap, QTextBlockFormat, QIcon
...
class MessageScreen(QWidget):
    def __init__(self, parent=None):
        ...
        self.label.setStyleSheet("color: white; font-size: 18px; padding: 10px;")
        layout.addWidget(self.label)
